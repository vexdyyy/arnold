...
module.exports = {
    ...
    execute: async (interaction) => {
        ...
        const bakimmodu = new EmbedBuilder()
            ...
            .setDescription(`Herhangi bir sorunuz vs. varsa <@914549149028982835>'e ulaşınız!`);

        if (db.fetch(`bakim`)) {
            if (interaction.user.id !== "914549149028982835") { return interaction.reply({ embeds: [bakimmodu]}) }
        }
